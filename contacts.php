        ...
        <div class="container py-5">
            <div class="row">
                <div class="order-lg-2 mb-3 mb-lg-0 col-lg-6 w-50 mx-auto">
                    <svg class="text-info" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="30ad16f1-5c99-460e-a21a-a10b3717755f" data-name="Layer 1" width="100%" height="100%" viewBox="0 0 1080 828.86">
                        <defs>
